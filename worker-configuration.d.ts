/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f0aaba32b4f267621d5239494ed2c86b)
// Runtime types generated with workerd@1.20260708.1 2026-07-06 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	APP_ORIGIN: "https://eng-learn.0xsolax.workers.dev";
	ADMIN_BROWSER_AUTH_MODE: "application_session";
	LESSON_QUEUE_WRITE_MODE: "v2";
	LESSON_FLOW_WRITE_MODE: "legacy_v1";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "ADMIN_BROWSER_AUTH_MODE" | "LESSON_QUEUE_WRITE_MODE" | "LESSON_FLOW_WRITE_MODE">> {}
}
